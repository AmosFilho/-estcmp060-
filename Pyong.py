...
def change_ball_angle(direction_x=1, direction_y=1):
    """:param direction_x: Define the ball direction on x coordinate,
    1 to the right and -1 to the left.
    
    :param direction_y: Define the ball direction on y coordinate, 1 to
    the top and -1 to the down.
    """
